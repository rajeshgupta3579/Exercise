...
public class DriverLocation {
    ...
    public DriverLocation(String tickerSymbol, TradeType tradeType, double price, long quantity, long id) {
    ...
    public static DriverLocation fromJsonAsBytes(byte[] bytes) {
        try {
            return JSON.readValue(bytes, DriverLocation.class);
        } catch (IOException e) {
            return null;
        }
    }
